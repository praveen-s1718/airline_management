...
const ReviewForm = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    console.log('https://airline-management-tco0.onrender.com/api/addreviews/newairline');
    fetch('https://airline-management-tco0.onrender.com/api/addreviews/newairline', {
      method: 'PUT',
      headers: {
