...
const LoginPage = ({ setIsLoggedIn }) => {
    ...
    const handleSignupSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`https://airline-management-tco0.onrender.com/api/passenger/register?username=${username}&password=${password}&email=${email}&name=${name}&contact=${contact}`, {
                method: 'POST',
                headers: {
    ...
    const handleLoginSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`https://airline-management-tco0.onrender.com/api/passenger/authenticate?username=${username}&password=${password}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleAdminLoginSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`https://airline-management-tco0.onrender.com/api/admin/authenticate?username=${username}&password=${password}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
