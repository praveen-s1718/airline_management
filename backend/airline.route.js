...
// MULTI-CITY TRIP ROUTES
// POST search for multi-city flights
router.post('/flights/multicity', searchMultiCityFlights);
// POST create a new multi-city itinerary
router.post('/itineraries', bookItinerary);
